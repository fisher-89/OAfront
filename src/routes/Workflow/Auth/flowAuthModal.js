...
@connect(({ workflow, loading }) => ({
  list: workflow.flowList.data,
  total: workflow.flowList.total,
  loading: loading.effects['workflow/flowList'],
}))

export default class FlowAuthModal extends Component {
  state = {
  ...
  // table 字段
  columns = [
    { title: '流程编号', dataIndex: 'number', align: 'center', searcher: true },
    { title: 'ID', dataIndex: 'id', align: 'center', sorter: true },
    { title: '流程名称', dataIndex: 'name', align: 'center', searcher: true },
    {
      title: '状态',
      dataIndex: 'is_active',
      align: 'center',
