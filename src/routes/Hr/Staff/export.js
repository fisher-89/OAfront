...
export default class extends PureComponent {
  state = {
    maxCols: [
      '员工编号', '姓名', '性别', '品牌', '费用品牌', '部门全称', '店铺代码', '店铺名称', '职位', '员工状态', '生日', '入职时间', '转正日期',
      '离职时间', '员工属性', '备注', '手机号码', '身份证号', '银行卡号', '开户人', '开户行', '民族', 'QQ号', '微信号', '邮箱', '学历',
      '政治面貌', '婚姻状况', '身高', '体重', '户口所在地址', '现居住地址', '籍贯', '紧急联系人', '紧急联系人电话', '联系人关系类型',
    ],
    minCols: ['员工编号', '姓名', '性别', '品牌', '费用品牌', '部门全称', '店铺代码', '店铺名称', '职位', '员工状态', '生日', '入职时间', '转正日期', '离职时间', '员工属性', '备注'],
  }
